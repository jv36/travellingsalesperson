//
// Created by joaomendes on 06-05-2024.
//

#ifndef TRAVELLINGSALESPERSON_MUTPRIORQ_H
#define TRAVELLINGSALESPERSON_MUTPRIORQ_H
#include <vector>
...
#endif //TRAVELLINGSALESPERSON_MUTPRIORQ_H
